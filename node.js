...
const articles = [
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Wakala (Agency)</h3>
      <p>The customer appoints the bank as an agent to invest their money. The bank charges a fee or shares in the profit, but the investment risk lies with the customer.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <blockquote>"Gold for gold, silver for silver, wheat for wheat, barley for barley, dates for dates, salt for salt — like for like, equal for equal, hand to hand. If the types differ, then sell however you like, provided it is hand to hand." — Sahih Muslim</blockquote>
      ...
      <h3>4. Trading Based on Analysis, Not Speculation</h3>
      <p>Trading should be based on genuine analysis and economic fundamentals, not pure speculation or gambling on price movements.</p>
      ...
      <h2>Practical Tips for Muslim Forex Traders</h2>
      <ol>
        <li>Open a verified Islamic (swap-free) forex account</li>
        <li>Use minimal leverage (10:1 or less recommended)</li>
        <li>Focus on spot transactions only</li>
        <li>Develop a genuine trading strategy based on analysis</li>
        <li>Never trade with borrowed money or money you cannot afford to lose</li>
        <li>Avoid trading exotic or unclear instruments</li>
      </ol>
  ...
  },
  {
    ...
    content: `
      ...
      <h2>The Problem with Signing the Agreement</h2>
      <p>Some scholars raise an important concern: even if you intend to pay in full, the credit card agreement includes terms about interest charges. By signing, you are agreeing to potentially pay riba. This is a valid concern, and some scholars consider it problematic.</p>

      <p>However, the majority of contemporary scholars, including those at the Islamic Fiqh Academy, have ruled that signing the agreement is permissible as long as your firm intention and practice is to never incur interest.</p>
      ...
      <ol>
        <li>Only use a credit card if you can commit to paying the full balance monthly</li>
        <li>Set up automatic full payments to avoid accidental interest charges</li>
        <li>Never use cash advance features</li>
        <li>If an Islamic credit card is available, prefer it</li>
        <li>Keep your spending within your means — credit cards make overspending easy</li>
        <li>If you ever incur interest accidentally, pay it off immediately and seek forgiveness</li>
      </ol>
...
function renderCategories() {
  ...
  categories.forEach(cat => {
    ...
    card.addEventListener('click', () => {
      // Scroll to latest section for now
...
function renderArticlePage() {
  ...
  if (!headerEl) return; // Not on article page
  ...
  if (relatedEl) {
    ...
    if (related.length > 0) {
      ...
      if (relatedGrid) {
        related.forEach(a => {
          relatedGrid.appendChild(createArticleCard(a));
        });
      }
    }
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Delayed init for scroll animations (after cards render)
