...
const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxfQFnzR40rlz063tDOYiQU55VKJ6oxd2JSBSR9FNtN6FrTZJ49vqXMXtSSrTRxRXnVmQ/exec';

// ---- Hadith Data ----
const hadiths = [
  {
    text: "The truthful, honest merchant will be with the Prophets, the truthful, and the martyrs on the Day of Resurrection.",
    source: "Tirmidhi 1209 â€” Sahih"
  },
  {
    text: "Whoever of you wakes up in the morning secure in his home, healthy in body, and having enough food for that day â€” it is as if the entire world has been gathered for him.",
    source: "Tirmidhi 2346 â€” Hasan"
  },
  {
  ...
  },
  {
    ...
    source: "Sahih Bukhari â€” Book of Zakat"
  },
  {
  ...
  },
  {
    ...
    source: "Musnad Ahmad â€” Authenticated"
  },
  {
...
const articles = [
  {
    ...
    icon: "Equities",
    content: `
      <p>Stock trading is one of the most discussed topics in Islamic finance. Muslims around the world want to grow their wealth while staying within the boundaries set by Shariah law. The good news is that stock trading is not inherently haram â€” but it comes with important conditions.</p>

      <h2>The Basic Ruling</h2>
      <p>According to the majority of Islamic scholars, buying and selling shares of companies is permissible in principle. When you buy a stock, you are purchasing partial ownership of a real business â€” and owning a business is clearly halal in Islam.</p>

      <blockquote>"Trade is permitted, and interest (riba) is forbidden." â€” Quran 2:275</blockquote>
      ...
      <p>Even when investing in screened stocks, a small percentage of the company's income may come from impermissible sources. Scholars recommend calculating this percentage and donating that portion of your dividends to charity â€” a process known as "purification."</p>
    ...
    references: [
      ...
      "Dr. Monzer Kahf â€” 'Islamic Finance: Principles and Practice'",
      "Quran 2:275 â€” On the permissibility of trade"
    ]
  },
  {
    ...
    content: `
      ...
      <h2>What is Riba?</h2>
      <p>Riba literally means "increase" or "excess." In Islamic finance, it refers to any guaranteed increase in a loan â€” essentially what modern finance calls "interest." The prohibition of riba is one of the clearest and most emphasized rulings in the Quran and Sunnah.</p>

      <blockquote>"Allah has permitted trade and has forbidden riba (interest)." â€” Quran 2:275</blockquote>

      <div class="info-box warning">
        <p><strong>Clear Ruling:</strong> The overwhelming majority of scholars agree that conventional mortgages involve riba and are therefore haram. The Prophet (peace be upon him) cursed the one who pays interest, the one who receives it, the one who writes it, and the two witnesses â€” saying they are all equal in sin (Sahih Muslim).</p>
      </div>
      ...
      <ul>
        ...
        <li>The bank profits from lending money â€” not from any real economic activity</li>
      ...
      <p>The bank purchases the property and sells it to you at a higher price, payable in installments. The profit margin is agreed upon upfront. While the end result may seem similar, the structure involves a real sale â€” the bank takes ownership risk, even if briefly.</p>
    ...
    `,
    references: [
      "Quran 2:275-280 â€” Verses on the prohibition of riba",
      "Sahih Muslim â€” Hadith on the curse of riba",
      "European Council for Fatwa and Research â€” Resolution on Mortgages",
      "AAOIFI Shariah Standard No. 8 â€” Murabaha",
      "Dr. Muhammad Taqi Usmani â€” 'An Introduction to Islamic Finance'"
    ]
  },
  {
    id: "cryptocurrency-islamic-view",
    title: "Is Cryptocurrency Halal or Haram? An Islamic Perspective",
    description: "Examining Bitcoin, Ethereum, and other cryptocurrencies through the lens of Islamic jurisprudence â€” the arguments for and against.",
    category: "Crypto",
    ...
    content: `
      ...
      <ul>
        <li>Decentralized â€” no central bank or government controls it</li>
      ...
      <p>The underlying technology is simply a tool â€” like the internet itself. It can be used for halal or haram purposes. The technology itself is not the issue.</p>
    ...
    `,
    references: [
      "Dr. Monzer Kahf â€” Fatwa on Bitcoin (2018)",
      "Dar al-Ifta al-Misriyyah â€” Ruling on Bitcoin",
      "AAOIFI â€” Discussion Paper on Cryptocurrency",
      "Mufti Faraz Adam â€” 'Is Bitcoin Halal?' Research Paper",
      "Journal of Islamic Banking and Finance â€” Vol. 36"
    ]
  },
  {
    ...
    content: `
      ...
      <p>Zakat is an annual obligation of 2.5% on qualifying wealth that has been held for one lunar year (hawl). It is not merely charity â€” it is a right that the poor have over the wealthy.</p>

      <blockquote>"Take from their wealth a charity by which you purify them and cause them increase." â€” Quran 9:103</blockquote>
      ...
      <p>Gold and silver â€” whether jewelry, coins, or bars â€” are subject to zakat. Calculate the current market value and apply 2.5%. Note: there is scholarly disagreement about whether jewelry worn regularly by women is subject to zakat.</p>
      ...
      <p>Property held for rental income is not subject to zakat on its value â€” only the rental income saved is zakatable. Property held for resale (investment/flipping) is fully zakatable.</p>
    ...
    `,
    references: [
      "Quran 9:103 â€” On the obligation of Zakat",
      "Fiqh al-Zakat by Dr. Yusuf al-Qaradawi",
      "AAOIFI Shariah Standard No. 35 â€” Zakat",
      "IslamQA â€” Rulings on Zakat Calculation"
    ]
  },
  {
    ...
    content: `
      ...
      <h3>Real Estate</h3>
      <p>Buying property â€” whether for personal use, rental income, or resale â€” is one of the most straightforward halal investments. Property is a tangible asset with real value.</p>
      ...
      <p>Bonds are essentially loans that pay interest â€” pure riba. This includes government bonds, corporate bonds, and treasury bills.</p>
      ...
      <ul>
        ...
        <li><strong>Sukuk:</strong> Generally halal but must be properly structured â€” not all sukuk are truly Shariah-compliant</li>
      </ul>
    ...
    `,
    references: [
      "AAOIFI Shariah Standards â€” Complete Collection",
      "Securities Commission Malaysia â€” Islamic Capital Market Guidelines",
      "Dr. Muhammad Taqi Usmani â€” 'An Introduction to Islamic Finance'",
      "Quran 2:275 and 2:278-279 â€” Prohibition of Riba"
    ]
  },
  {
    ...
    content: `
      ...
      <p>The bank purchases an asset and sells it to the customer at a disclosed markup, payable in installments. The profit margin is fixed and known upfront â€” it is not interest because it involves a real sale.</p>
      ...
      <div class="info-box">
        <p><strong>Key Difference:</strong> The fundamental difference between Islamic and conventional banking is that Islamic banks must engage in real economic activity. They cannot simply lend money and charge interest â€” they must buy, sell, lease, or partner in actual assets and businesses.</p>
      </div>
    ...
    `,
    references: [
      "Islamic Financial Services Board (IFSB) â€” Standards",
      "Bank Negara Malaysia â€” Islamic Banking Guidelines",
      "AAOIFI â€” Shariah Standards for Islamic Financial Institutions",
      "Dr. Muhammad Taqi Usmani â€” 'An Introduction to Islamic Finance'"
    ]
  },
  {
    ...
    icon: "Takaful",
    content: `
      <p>Insurance is a necessity in modern life â€” from health coverage to car insurance to protecting your home. But is conventional insurance permissible in Islam? And what is the alternative? Let's explore this important topic.</p>
      ...
      <p>Some scholars argue that conventional insurance resembles gambling â€” you pay a small amount hoping to receive a large payout if a specific event occurs.</p>
    ...
    `,
    references: [
      "Islamic Fiqh Academy (OIC) â€” Resolution on Insurance (1985)",
      "AAOIFI Shariah Standard No. 26 â€” Islamic Insurance",
      "Malaysian Takaful Association Guidelines",
      "Dr. Engku Rabiah â€” 'Takaful: Principles and Practice'"
    ]
  },
  {
    id: "forex-trading-ruling",
    title: "Is Forex Trading Halal? The Islamic Ruling Explained",
    description: "An in-depth look at currency trading in Islam â€” when it's permissible, when it's not, and the conditions scholars have set.",
    category: "Investments",
    author: "Dr. Ahmed Al-Rashid",
    date: "August 14, 2025",
    verdict: "Conditional",
    ...
    content: `
      ...
      <p>Islam permits currency exchange â€” the Prophet (peace be upon him) explicitly allowed it. However, he set strict conditions based on the hadith known as the "hadith of the six commodities":</p>

      <blockquote>"Gold for gold, silver for silver, wheat for wheat... like for like, equal for equal, hand to hand. If the types differ, then sell however you like, provided it is hand to hand." â€” Sahih Muslim</blockquote>
    ...
    `,
    references: [
      "Sahih Muslim â€” Hadith on Currency Exchange",
      "Islamic Fiqh Academy â€” Resolution on Currency Trading",
      "Dr. Monzer Kahf â€” Fatwa on Forex Trading",
  ...
  },
  {
    ...
    description: "The nuanced ruling on using credit cards â€” when it becomes haram and how to use them in a Shariah-compliant way.",
    category: "Banking & Loans",
    author: "Dr. Fatima Hassan",
    ...
    icon: "Credit",
    content: `
      <p>Credit cards are ubiquitous in modern life. From online shopping to hotel bookings to building a credit score â€” they seem almost essential. But for Muslims, the question remains: can we use credit cards without falling into riba?</p>

      <h2>The Core Issue: Interest</h2>
      <p>The fundamental concern with credit cards is the interest charged on unpaid balances. When you don't pay your full balance by the due date, the bank charges interest on the remaining amount. This interest is riba â€” and it is unquestionably haram.</p>
      ...
      <p>If you pay your entire balance before the due date every single month, you never incur interest charges. In this case, the credit card functions essentially as a deferred payment tool â€” which is permissible.</p>
      ...
      <ul>
        <li><strong>Bai' al-Inah:</strong> The bank sells an asset to you on credit and buys it back for less â€” generating the credit line</li>
        ...
        <li><strong>Charge Cards:</strong> No credit extended â€” must pay in full each month</li>
      </ul>
    ...
    `,
    references: [
      "Islamic Fiqh Academy â€” Resolution on Credit Cards",
      "Dr. Wahbah al-Zuhayli â€” 'Financial Transactions in Islamic Jurisprudence'",
      "AAOIFI Shariah Standard No. 2 â€” Debit and Credit Cards",
      "Mufti Taqi Usmani â€” Fatwa on Credit Card Usage"
    ]
  }
];
...
function getVerdictIcon(verdict) {
  const v = verdict.toLowerCase();
  if (v === 'halal') return 'Permissible';
  if (v === 'haram') return 'Not permissible';
...
function initHadithOverlay() {
  ...
  if (sourceEl) sourceEl.textContent = `â€” ${hadith.source}`;
  ...
  card.innerHTML = `
    <div class="article-card-image">
      ...
      <div class="card-image-label">
        <span class="verdict-badge ${getVerdictClass(article.verdict)}">${getVerdictIcon(article.verdict)}</span>
      </div>
    </div>
    <div class="article-card-body">
      ...
      <div class="card-footer">
        ...
        <span class="card-read-more">Read More <span class="arrow">â†’</span></span>
      </div>
    </div>
  `;
...
function renderCategories() {
  ...
  const categories = [
    { name: "Halal vs Haram", icon: "Principles", desc: "Clear rulings" },
    { name: "Investments", icon: "Portfolios", desc: "Grow your wealth" },
    { name: "Banking & Loans", icon: "Banking", desc: "Halal banking" },
    { name: "Crypto", icon: "Digital Assets", desc: "Digital assets" },
    { name: "Zakat & Charity", icon: "Giving", desc: "Give back" }
  ];
...
function renderArticlePage() {
  ...
  headerEl.innerHTML = `
    ...
    <div class="article-meta-bar">
      ...
      <span class="verdict-badge verdict-badge-lg ${getVerdictClass(article.verdict)}">${getVerdictIcon(article.verdict)}</span>
    </div>
  `;
...
async function submitLeadToGoogleSheets(payload) {
  ...
  if (!result || result.success !== true) {
    throw new Error(result?.message || 'Lead was not saved.');
  }
